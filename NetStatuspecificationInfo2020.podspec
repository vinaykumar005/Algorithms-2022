...
Pod::Spec.new do |s|
  s.name             = 'NetStatuspecificationInfo2020'
  s.version          = '0.1.0'
  s.summary          = 'Internet staus summary'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/vinaykumar005/SamplePod'
  ...
  s.source_files = "NetStatus/NetStatus/Sources/NetStatus.swift"
  s.swift_version = '4.0'
